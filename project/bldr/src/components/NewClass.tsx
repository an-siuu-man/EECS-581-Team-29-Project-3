...
export default function NewClass(props: NewClassProps) {
  ...
  const handleClick = (
    ...
    const isAlreadyPresent = selectedClasses.some(
      ...
      >
        ...
        <button
          className={`w-full font-inter rounded-md mt-2 cursor-pointer hover:bg-[#2c2c2c] ${
            selectedClasses.some((cls) => cls.classID === props.classID)
              ? "bg-green-950"
              : ""
          ...
          <table className="w-full">
            <tbody>
              <tr className="text-left">
                ...
                <td className="pt-2">
                  {props.days} {props.startTime} - {props.endTime}
                </td>
              </tr>
              <tr className="text-left">
                <td></td>
                <td className="pb-2 text-xs text-[#a8a8a8]">
                  {props.instructor}
                </td>
              </tr>
            </tbody>
